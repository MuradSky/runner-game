...
const data = [
    {
        ...
        name: 'Максим',
        pos: 'Маркетолог',
        text: 'Борется за узнаваемость бренда и привлечение новых клиентов'
    },
    {
        id: 2,
        person: 'rom',
        name: 'РОМА',
        pos: 'Руководитель',
        text: 'Помогает бизнесу расти через внедрение инноваций и цифровизацию'
    },
    {
        id: 3,
        person: 'ann',
        name: 'Анна',
        pos: 'HR-директор',
        text: 'Заботится о привлечении и удержании талантов в компании. Переживает за вовлеченность и лояльность сотрудников'
    },
];
